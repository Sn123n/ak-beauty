                                    ...
                                    <tbody>
                                        @foreach ($blogs as $blog)
                                            <tr>
                                                ...
                                                <td>{{ $blog->title }}</td>
                                                <td>{{ optional($blog->blogcategories)->name }}</td>
                                                ...
                                                <td>
                                                    <select class="form-control status-dropdown form-select"
                                                        data-id="{{ $blog->id }}" onchange="changeStatus(this, 'blogs')">
                                                ...
                                                <td>
                                                    <div class="action-btn">
                                                        <a href="{{ route('blogs.edit', $blog->id) }}" class=" btn-sm"> <i
                                                        ...
                                                        <form action="{{ route('blogs.destroy', $blog->id) }}" method="POST"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn" onclick="return confirm('Are you sure you want to delete this blogs?')">
