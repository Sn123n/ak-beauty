                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <h4 class="header-title">Manage Testimonial</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control status-dropdown form-select"
                                                            ...
                                                            onchange="changeStatus(this, 'testimonial')">
                                                            <option value="1"
                                                                {{ $testimonial->status == 1 ? 'selected' : '' }}>Active</option>
                                                            <option value="0"
                                                                {{ $testimonial->status == 0 ? 'selected' : '' }}>Deactive</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <div class="action-btn">
                                                            ...
                                                            <form action="{{ route('testimonial.destroy', $testimonial->id) }}"
                                                                ...
                                                                @method('DELETE')
                                                                <button type="submit"
                                                                    class="btn" onclick="return confirm('Are you sure you want to delete this testimonial?')">
