                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('testimonial.index') }}" class="btn btn-primary">Manage Testimonial</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="editor" name="content" rows="3" placeholder="Enter content">{{ old('content', $testimonial->content ?? '') }}</textarea>
                                            @error('content')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
