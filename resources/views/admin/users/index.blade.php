                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($user->image)
                                                        <img src="{{ asset('user/' . $user->image) }}" width="100"
                                                            alt="User Image">
                                                    @else
                                                        @php
                                                            $defaultImage =
                                                                $user->gender == 1 ? 'male.png' : 'female.png';
                                                        @endphp
                                                        <img src="{{ asset('profile/' . $defaultImage) }}" width="100"
                                                ...
                                                <td>
                                                    <select class="form-control status-dropdown form-select"
                                                        data-id="{{ $user->id }}"
                                                        onchange="changeStatus(this, 'users')">
                                                ...
                                                <td>
                                                    <div class="action-btn">
                                                        <a href="{{ route('users.edit', $user->id) }}" class=" btn-sm"> <i
                                                        ...
                                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn" onclick="return confirm('Are you sure you want to delete this users?')">
