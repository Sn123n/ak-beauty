                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        {{-- <span class="size-notes">Note: size 2500(width) x 1300(height)</span> --}}
                                        @error('image')
                                            <div class="text-danger">{{ $message}}</div>
                                        @enderror
                                    </div>
                                ...
                                {{-- <div class="col-lg-6 col-md-6">
                                    <div class="mb-3">
                                        <label for="homeimage" class="form-label">Home Image</label>
                                        <input type="file" id="homeimage" name="homeimage" class="form-control">
